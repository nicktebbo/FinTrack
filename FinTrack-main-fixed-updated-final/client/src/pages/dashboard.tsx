              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">
                    {summary?.totalAssets ? formatCurrency(summary.totalAssets) : "$0"}
                  </p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">
                    {summary?.totalInvestments ? formatCurrency(summary.totalInvestments) : "$0"}
                  </p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">
                    {summary?.monthlySpending ? formatCurrency(summary.monthlySpending) : "$0"}
                  </p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">
                    {summary?.totalRetirement ? formatCurrency(summary.totalRetirement) : "$0"}
                  </p>
                </div>
